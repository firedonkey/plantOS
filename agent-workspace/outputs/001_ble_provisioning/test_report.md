...
platform/backend/tests/test_platform_app.py ....                         [ 79%]
...
====================== 114 passed, 401 warnings in 1.74s =======================
```
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
====================== 114 passed, 401 warnings in 1.57s =======================
```
