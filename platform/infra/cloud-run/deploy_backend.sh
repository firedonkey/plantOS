...
PLANTLAB_DATABASE_POOL_SIZE="${PLANTLAB_DATABASE_POOL_SIZE:-2}"
PLANTLAB_DATABASE_POOL_MAX_OVERFLOW="${PLANTLAB_DATABASE_POOL_MAX_OVERFLOW:-1}"
PLANTLAB_DATABASE_POOL_TIMEOUT_SECONDS="${PLANTLAB_DATABASE_POOL_TIMEOUT_SECONDS:-10}"
PLANTLAB_DATABASE_POOL_RECYCLE_SECONDS="${PLANTLAB_DATABASE_POOL_RECYCLE_SECONDS:-1800}"
PLANTLAB_DATABASE_POOL_PRE_PING="${PLANTLAB_DATABASE_POOL_PRE_PING:-true}"
PLANTLAB_CLOUD_RUN_MAX_INSTANCES="${PLANTLAB_CLOUD_RUN_MAX_INSTANCES:-4}"
PLANTLAB_CLOUD_RUN_CONCURRENCY="${PLANTLAB_CLOUD_RUN_CONCURRENCY:-20}"
...
runtime_env_vars() {
  require_runtime_env
  printf '%s' "^~^APP_ENV=production~GOOGLE_CLOUD_PROJECT=${PROJECT_ID}~PLANTLAB_STORAGE_BACKEND=gcs~GCS_BUCKET_NAME=${BUCKET_NAME}~PLANTLAB_IMAGE_URL_STRATEGY=proxy~PLANTLAB_FIRMWARE_STORAGE_BACKEND=gcs~PLANTLAB_FIRMWARE_BUCKET_NAME=${BUCKET_NAME}~PLANTLAB_FIRMWARE_PREFIX=firmware~DB_NAME=${DB_NAME}~DB_USER=${DB_USER}~CLOUD_SQL_CONNECTION_NAME=${CLOUD_SQL_CONNECTION_NAME}~PLANTLAB_DATABASE_POOL_PRE_PING=${PLANTLAB_DATABASE_POOL_PRE_PING}~PLANTLAB_DATABASE_POOL_SIZE=${PLANTLAB_DATABASE_POOL_SIZE}~PLANTLAB_DATABASE_POOL_MAX_OVERFLOW=${PLANTLAB_DATABASE_POOL_MAX_OVERFLOW}~PLANTLAB_DATABASE_POOL_TIMEOUT_SECONDS=${PLANTLAB_DATABASE_POOL_TIMEOUT_SECONDS}~PLANTLAB_DATABASE_POOL_RECYCLE_SECONDS=${PLANTLAB_DATABASE_POOL_RECYCLE_SECONDS}~PLANTLAB_DEV_TOKEN_AUTH_ENABLED=false~PLANTLAB_APPLE_CLIENT_ID=${PLANTLAB_APPLE_CLIENT_ID}~PLANTLAB_PROVISIONING_API_URL=${PROVISIONING_URL}~PLANTLAB_PROVISIONING_PUBLIC_URL=${PROVISIONING_URL}~PLANTLAB_LOCAL_SETUP_URL=${PLANTLAB_LOCAL_SETUP_URL}~PLANTLAB_DEVICE_PLATFORM_URL=${PLANTLAB_DEVICE_PLATFORM_URL}~PLANTLAB_STANDALONE_WEB_ORIGIN_REGEX=${PLANTLAB_STANDALONE_WEB_ORIGIN_REGEX}~PLANTLAB_STANDALONE_MOBILE_SCHEME=plantlab~PLANTLAB_STANDALONE_REFRESH_COOKIE_SAMESITE=lax"
}
...
PLANTLAB_DATABASE_POOL_SIZE=${PLANTLAB_DATABASE_POOL_SIZE}
PLANTLAB_DATABASE_POOL_MAX_OVERFLOW=${PLANTLAB_DATABASE_POOL_MAX_OVERFLOW}
PLANTLAB_DATABASE_POOL_TIMEOUT_SECONDS=${PLANTLAB_DATABASE_POOL_TIMEOUT_SECONDS}
PLANTLAB_DATABASE_POOL_RECYCLE_SECONDS=${PLANTLAB_DATABASE_POOL_RECYCLE_SECONDS}
PLANTLAB_DATABASE_POOL_PRE_PING=${PLANTLAB_DATABASE_POOL_PRE_PING}
PLANTLAB_CLOUD_RUN_MAX_INSTANCES=${PLANTLAB_CLOUD_RUN_MAX_INSTANCES}
PLANTLAB_CLOUD_RUN_CONCURRENCY=${PLANTLAB_CLOUD_RUN_CONCURRENCY}
...
cmd_deploy_staging() {
  ...
  gcloud run deploy "$STAGING_SERVICE_NAME" \
    ...
    --max-instances "$PLANTLAB_CLOUD_RUN_MAX_INSTANCES" \
    --concurrency "$PLANTLAB_CLOUD_RUN_CONCURRENCY" \
